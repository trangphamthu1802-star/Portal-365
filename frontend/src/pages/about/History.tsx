...
export default function History() {
  ...
  useEffect(() => {
    apiClient
      .get('/introduction/lich-su-truyen-thong')
      .then((res) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 md:px-6 lg:px-8 py-8">
        ...
        <div className="relative bg-gradient-to-r from-red-700 to-red-900 rounded-2xl overflow-hidden mb-8 shadow-xl">
          ...
          <div className="relative px-8 py-16 md:py-20">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-red-100">
                Hành trình xây dựng và trưởng thành của Sư đoàn 365
              </p>
            </div>
          </div>
          {/* Decorative element */}
        ...
        <div className="mb-8 bg-white rounded-xl shadow-sm p-4">
          <div className="flex items-center justify-center space-x-2 overflow-x-auto">
            <button className="px-4 py-2 bg-red-600 text-white rounded-lg font-medium whitespace-nowrap">
              Lịch sử hình thành
            </button>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <nav className="space-y-2">
                  <a
                    ...
                    className="block px-4 py-3 bg-red-50 text-red-700 rounded-lg font-medium"
                  >
